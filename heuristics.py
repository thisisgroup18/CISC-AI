...
def ord_dh(csp):
    ...
    for var in unassigned:
        ...
        # Update maximum if we find more constraints
...
def ord_mrv(csp):
    ...
    # Track minimum domain size and corresponding variable
    ...
    for var in unassigned[1:]:
        ...
        if domain_size == 0:  # Handle case where domain is empty
            return var  # Return immediately as this is a failure case
